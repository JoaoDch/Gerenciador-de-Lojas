...
public class Principal {
    public static void main(String[] args) {
        ...
        // Objetos Loja e Produto ainda não existem, então começam como Nulo
        Loja loja = null;
        Produto produto = null;

        // O menu continuará aparecendo até que o usuário escolha sair, ou dê algum erro
        while (true) {
            System.out.println("\nMenu:");
            ...
            switch (opcao) {
                // Scanner pra capturar entradas do usuário
                case 1:
                    System.out.println("\n--- Criar Loja ---");
                    scanner.nextLine(); 
